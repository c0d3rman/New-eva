(function() {
  window.onNewevaReady(function() {
    ...
    return $("#bgrfail").css("top", Math.max(0, (($(window).height() - $("#bgrfail").height()) / 2) + $(window).scrollTop()) + "px").css("left", Math.max(0, (($(window).width() - $("#bgrfail").width()) / 2) + $(window).scrollLeft()) + "px");
  });
